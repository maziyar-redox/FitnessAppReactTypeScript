        ...
        <>
            <section id="contactus" className="mx-auto w-5/6 pt-24 pb-32">
                <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.ContactUs)}>
                    {/* HEADER */}
                    <motion.div className="md:w-3/5" viewport={{ once: true, amount: 0.5 }} variants={{
                        hidden: { opacity: 0, x: -50 },
                        visible: { opacity: 1, x: 0 }
                    }} transition={{ duration: 0.5}} initial="hidden" whileInView="visible">
                        <HText>
                    ...
                    <div className="mt-10 justify-between gap-8 md:flex">
                        <motion.div className="mt-10 basis-3/5 md:mt-0" viewport={{ once: true, amount: 0.5 }} variants={{
                        hidden: { opacity: 0, y: 50 },
                        visible: { opacity: 1, y: 0 }
                    }} transition={{ duration: 0.5}} initial="hidden" whileInView="visible">
                        <form target="_blank" onSubmit={onSubmit} method="POST" action="https://formsubmit.co/r6.acc.051@gmail.com">
                    ...
                    <motion.div className="relative mt-16 basis-2/5 md:mt-0" viewport={{ once: true, amount: 0.5 }} variants={{
                        hidden: { opacity: 0, y: 50 },
                        visible: { opacity: 1, y: 0 }
                    }} transition={{ delay: 0.2, duration: 0.5}} initial="hidden" whileInView="visible">
