    ...
    return (
        <section id="benefits" className="mx-auto min-h-full w-5/6 py-20">
            <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.Benefits)}>
                {/* HEADER */}
                <motion.div viewport={{ once: true, amount: 0.5 }} variants={{
                        hidden: { opacity: 0, x: -50 },
                        visible: { opacity: 1, x: 0 }
                    }} transition={{ duration: 0.5}} initial="hidden" whileInView="visible" className="md:my-5 md:w-3/5">
                    <HText>
                ...
                <div className="mt-16 items-center justify-between gap-20 md:mt-28 md:flex">
                    {/* GRAPHIC */}
                    <img src={BenefitsPageGraphic} className="mx-auto" alt="benefits-graph" />
                    {/* DESCRIPTION */}
                    <div>
                        {/* TITLE */}
                        <div className="relative">
                            <div className="before:absolute before:-top-20 before:-left-20 before:z-[-1] before:content-abstractwaves">
                                <motion.div viewport={{ once: true, amount: 0.5 }} variants={{
                                    ...
                                    <HText>
                                        MILIONS OF HAPPY MEMEBERS GETTING <span className="text-primary-500">FIT</span>.
                                    </HText>
                                </motion.div>
                            </div>
                        </div>
