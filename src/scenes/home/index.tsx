        ...
        <section id="home" className="gap-16 bg-gray-20 py-10 md:h-full md:pb-0">
            ...
            <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.Home)} className="md:flex mx-auto w-5/6 items-center justify-center md:h-5/6">
                ...
                <div className="z-10 mt-32 md:basis-3/5">
                    ...
                    }} transition={{ duration: 0.5}} initial="hidden" whileInView="visible" className="md:-mt-20">
                    ...
                    <motion.div viewport={{ once: true, amount: 0.5 }} variants={{
                        hidden: { opacity: 0, x: -50 },
                        visible: { opacity: 1, x: 0 }
                    }} transition={{ delay: 0.2, duration: 0.5}} initial="hidden" whileInView="visible" className="mt-8 flex items-center gap-8">
                ...
                <div className="h-[150px] w-full bg-primary-100 py-10">
                    <div className="mx-auto w-5/6">
                        <div className="flex w-3/5 items-center justify-between gap-8">
                            ...
                            <img src={SponsorFobes} alt="forbes-sponsor" />
